...
`endif
    ...
    logic spi_controller_bitstream_finish;
    logic [2:0]  spi_controller_slot_offset;
    logic [4:0]  spi_controller_col_offset;
    logic [12:0] spi_controller_slot_chunk_addr;
    ...
    wire  [12:0] fabric_warmboot_slot;
    ...
    wire [2:0]  cpu_warmboot_slot_offset;
    wire [4:0]  cpu_warmboot_col_offset;
    wire [12:0] cpu_warmboot_slot_chunk_addr;
    ...
    controller_io_interface controller_io_interface (
        ...
        .spi_controller_slot_chunk_addr_o   ( spi_controller_slot_chunk_addr  ),
        .spi_controller_slot_offset_o       ( spi_controller_slot_offset      ),
        .spi_controller_col_offset_o        ( spi_controller_col_offset       ),
        ...
        .spi_controller_bitstream_finish_o  ( spi_controller_bitstream_finish ),
        .fabric_warmboot_boot_i             ( fabric_warmboot_boot            ),
        .fabric_warmboot_slot_chunk_addr_i  ( fabric_warmboot_slot            ),
        .cpu_warmboot_boot_i                ( cpu_warmboot_boot               ),
        .cpu_warmboot_slot_chunk_addr_i     ( cpu_warmboot_slot_chunk_addr    ),
        .cpu_warmboot_slot_offset_i         ( cpu_warmboot_slot_offset        ),
        .cpu_warmboot_col_offset_i          ( cpu_warmboot_col_offset         ),
    ...
    fabric_spi_controller fabric_spi_controller (
        ...
        .bitstream_finish_i (spi_controller_bitstream_finish),
    ...
    (
        ...
        .warmboot_slot_o        (cpu_warmboot_slot_chunk_addr),
